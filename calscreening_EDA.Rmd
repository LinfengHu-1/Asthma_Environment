...
```
More quadratic & flexible modeling:
```{r}
#interaction terms
...
mods_linear <- list(lm_7linear, model_spline, lm_interWgt, lm_interEmp, lm_interPov, lm_interLing, lm_interDiesel, lm_interSoc, lm_interAir)

library(AICcmodavg)
aictab(cand.set = mods_linear)
```
