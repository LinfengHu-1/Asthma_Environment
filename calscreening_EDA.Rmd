...
```{r}
modnames <- c('poisson.simple','pm_ozone interaction ','ozone_diesel interaction','ozone_linguisticIsolation interaction','ozone_poverty interaction','ozone_lowbirthweight interaction','poisson quadratic ozone ','quadratic+pm2.5_ozone interaction')
