...
```{r}
model_spline=lm(Asthma~bSpline(Ozone,df=4)+ PM2.5 + DieselPM + DrinkingWater + Pesticides + Tox.Release + Traffic + CleanupSites + GroundwaterThreats + Haz.Waste + Imp.WaterBodies + PollutionBurden + LinguisticIsolation + Poverty + Unemployment + HousingBurden + LowBirthWeight + CardiovascularDisease,data=data_cal1)
summary(model_spline)
confint(model_spline)
#model evaluation
plot(model_spline)
```
