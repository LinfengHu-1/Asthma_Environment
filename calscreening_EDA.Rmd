...
```{r}
modnames <- c('mod.poisson.sim','modp.pm_ozone','modp.ozone_diesel','modp.ozone_linguisticIsolation','modp.ozone_poverty','modp.ozone_lowbirthweight','mod.poisson.qua','mod.poisson.qua.pm2.5ozone')
